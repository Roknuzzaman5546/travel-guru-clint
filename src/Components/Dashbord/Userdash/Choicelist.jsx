            ...
            </div>
            {
                choice.length > 0 ?
                    ...
                    : <div className=" flex flex-col justify-center items-center">
                        ...
                        <Link to={`/allplace`}>
                            <button className=" bg-[#ff9c1c] hover:bg-[#000] text-white px-3 py-2 rounded-md text-xl font-bold font-mono transition">Place</button>
                        </Link>
                        <Link to={'/hotel'}>
                            <button className=" bg-[#ff9c1c] hover:bg-[#000] text-white px-3 py-2 rounded-md text-xl font-bold font-mono transition ml-2">Hotel</button>
                        </Link>
                        </div>
                    </div>
            }
